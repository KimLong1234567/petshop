...
<body>
    ...
    <h3 style="padding: 20px 0 0 30px;"><button><a href="./view_book_pet_his.php">LICH SU</a></button></h3>
            ...
            <table class="table table-bordered">
                <thead>
                    ...
                    <tr>
                        ...
                        <td><a href="./delete_book_pet.php ?id=<?php echo $row['pet_id'] ?>"><button type="button"
                                    class="btn btn-sm btn-danger btn-create">Xoa
                                </button></a></td>
                    </tr>
                    <?php
                    }
